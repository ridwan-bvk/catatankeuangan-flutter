...
class $CategoriesTable extends Categories
  ...
  static const VerificationMeta _creatAtMeta =
      const VerificationMeta('creatAt');
  @override
  late final GeneratedColumn<DateTime> creatAt = GeneratedColumn<DateTime>(
      'creat_at', aliasedName, false,
  ...
  List<GeneratedColumn> get $columns =>
      [id, name, type, creatAt, updateAt, deleteAt];
  @override
  ...
  VerificationContext validateIntegrity(Insertable<category> instance,
    ...
    if (data.containsKey('creat_at')) {
      context.handle(_creatAtMeta,
          creatAt.isAcceptableOrUnknown(data['creat_at']!, _creatAtMeta));
    } else if (isInserting) {
      context.missing(_creatAtMeta);
    }
  ...
  category map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return category(
      ...
      creatAt: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}creat_at'])!,
...
class category extends DataClass implements Insertable<category> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['creat_at'] = Variable<DateTime>(creatAt);
  ...
  factory category.fromJson(Map<String, dynamic> json,
    ...
    return category(
      ...
      creatAt: serializer.fromJson<DateTime>(json['creatAt']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'creatAt': serializer.toJson<DateTime>(creatAt),
  ...
  @override
  int get hashCode => Object.hash(id, name, type, creatAt, updateAt, deleteAt);
  @override
...
class CategoriesCompanion extends UpdateCompanion<category> {
  ...
  const CategoriesCompanion({
    ...
    this.creatAt = const Value.absent(),
  ...
  static Insertable<category> custom({
    ...
    return RawValuesInsertable({
      ...
      if (creatAt != null) 'creat_at': creatAt,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (creatAt.present) {
      map['creat_at'] = Variable<DateTime>(creatAt.value);
    }
    if (updateAt.present) {
